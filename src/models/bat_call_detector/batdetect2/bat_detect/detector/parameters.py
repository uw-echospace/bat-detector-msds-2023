...
def get_params(make_dirs=False, exps_dir='../../experiments/'):
    ...
    # augmentation params
    params['aug_prob'] = 0.2              # augmentations will be performed with this probability
    ...
    params['generic_class'] = []
    params['events_of_interest'] = ['Echolocation', 'e']  # will ignore all other types of events e.g. social calls
